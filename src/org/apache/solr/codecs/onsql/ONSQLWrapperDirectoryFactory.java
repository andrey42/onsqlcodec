...
public class ONSQLWrapperDirectoryFactory extends StandardDirectoryFactory {
  private transient static Logger log = LoggerFactory.getLogger(ONSQLWrapperDirectoryFactory.class);
  boolean unmapHack;  
  ...
  protected Directory create(String path, DirContext dirContext) throws IOException {    
    ONSQLWrapperDirectory dir = new ONSQLWrapperDirectory(new File(path));
    try {
      dir.setUseUnmap(unmapHack);
    } catch (Exception e) {
